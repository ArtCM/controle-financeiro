...
export default function Header() {
    ...
    return(
        <>
            <header className='bg-black p-5 grid grid-cols-1 md:grid-cols-2'>
                <div className='flex flex-col justify-center items-center md:justify-center md:items-start md:pl-5'>
                    ...
                    <div className='flex social-midia py-3'>
                        <Link href="https://www.instagram.com/arthurcoorrea/" target='blank'>
                            <svg xmlns="http://www.w3.org/2000/svg" height={30} width={30} fill='#fff' viewBox="0 0 448 512">
